...
?>
    <?php if (Auth::isLogin()) : ?>
        <form class="validate-form" action="<?php the_url('topic/detail'); ?>" method="POST" novalidate autocomplete="off">
            ...
            <div class="container">
                <div class="row h4 form-group">
                    ...
                    <input type="submit" value="送信" class="btn btn-success shadow-sm col" />
                </div>
            </div>
        </form>
    <?php else : ?>
